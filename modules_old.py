...
from torch.nn import Linear, Module, LSTM, Parameter, BatchNorm2d, Conv2d, ConvTranspose2d, Softmax
...
class STL10ConvEncoder_freq(Module):
	def __init__(self, p, l):
		...
		self.mag_conv1 = Conv2d(1,  64, 35,stride=5, padding=1)
...
class STL10ConvDecoder_freq(Module):
	...
	def __init__(self, p, l):
		...
		self.fc1 = Linear(self.latents, self.hidden)
		self.fc2 = Linear(self.hidden, 256)

		self.dec1 = ConvTranspose2d(256, 256, 1, padding=1)
		self.bn1  = BatchNorm2d(256)
		
		self.dec2 = ConvTranspose2d(256, 256, 1,padding=1)
		self.bn2  = BatchNorm2d(256)
		self.dec3 = ConvTranspose2d(256, 128, 2, stride=2,padding=1,dilation=2)
		self.bn3  = BatchNorm2d(128)

		self.dec4 = ConvTranspose2d(128, 128, 2,padding=1)
		self.bn4  = BatchNorm2d(128)
		self.dec5 = ConvTranspose2d(128, 64, 3, padding=1)
		self.bn5  = BatchNorm2d(64)
		
		self.dec6 = ConvTranspose2d(64, 64, 2, stride=2,padding=1)
		self.bn6  = BatchNorm2d(64)
		
		self.dec7 = ConvTranspose2d(64,1,35,stride=5,padding=1)
